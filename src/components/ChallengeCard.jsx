    ...
    return (
        <div className="relative mt-4 h-[500px] w-[370px] transition-all duration-300 p-4 border-2 border-violet-400 hover:border-white rounded-4xl flex flex-col m-1 bg-gradient-to-t from-[#AE98E7]/25 to-[#9275E0]/25 hover:bg-gradient-to-t hover:from-[#9275E0] hover:to-[#AE98E7] group hover:shadow-[0_0_30px_rgba(167,139,250,0.7),0_0_60px_rgba(167,139,250,0.4)] hover:scale-[1.02] items-center">
            ...
            <h2
                ...
                className="text-[#FFFFFF] m-3 text-center leading-[130%] font-[700] text-[32px]"
            >
                {title}
            </h2>

          
            <div className="h-8 w-34 rounded-lg p-2 m-1 flex flex-row justify-center items-center border border-neutral-400 bg-gradient-to-b from-neutral-600 to-[#1f1f1f] group">
                ...
                <div className="relative group/nested">
                    ...
                    <span className="absolute bottom-full left-1/2 transform -translate-x-1/2 mb-[10px] w-max px-2 py-1 bg-black text-white text-[12px] transition-all duration-100 rounded-md opacity-0 group-hover/nested:opacity-100 pointer-events-none">
            ...
            <p
                ...
                className="text-[#FFFFFF] leading-[150%] text-center text-[16px] font-[400] mx-5 mt-7 line-clamp-5"
            >
                {description}
            </p>
            ...
            <div
                style={{ fontFamily: "Inter" }}
                className="flex p-1 absolute text-center items-center justify-center bottom-2 text-[10px] font-[500] m-2 text-white text-wrap"
            >
                <span>
                    <img className="h-[22px] w-[22px]" src="https://cdn.prod.website-files.com/623ae64112adcf772da9687e/678a08bb798234106f88d71f_burning.png" alt="" />
                </span>
