...
const HiringProcessSection = () => {
  return (
    ...
    <div className='flex flex-col items-center h-auto lg:w-3/4 w-auto lg:m-2 mx-10 p-2'>
      ...
      <iframe className='h-110 w-full' src="https://www.youtube.com/embed/pn_HoowYNTQ?si=HslG5hI4xqWCwtw_" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" referrerpolicy="strict-origin-when-cross-origin" allowfullscreen></iframe>
      </div>
{/* width="850" height="450" */}
    ...
    <div className='flex flex-col items-center h-auto lg:w-3/4 w-auto lg:m-2 mx-10 p-2'>
      ...
      <iframe className=" top-0 left-0 w-full h-84 md:h-110 rounded-lg border-purple-600 border"
         src="https://www.loom.com/embed/0847b9257f144fd0830a8536dfbc8e81?sid=a859384c-c000-4971-99c6-6e66db5662ab" frameborder="0" allowFullScreen  >
         </iframe>
      </div>
